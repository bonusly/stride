...
module Stride
  RSpec.describe TextMessage do
    describe '.send!' do
      ...
      let(:message_text) { 'I am the egg man, they are the egg men' }

      let(:message) { described_class.new('token', 1, 2, message_text) }

      context 'when successful' do
        before do
          stub_request(:post, 'https://api.atlassian.com/site/1/conversation/2/message').
            with(
